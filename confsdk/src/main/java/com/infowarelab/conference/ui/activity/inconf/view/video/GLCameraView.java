...
public class GLCameraView extends GLSurfaceView implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        Log.d("InfowareLab.Debug", "GLCameraView.surfaceDestroyed");

        if (camera != null && isPreview() && isEnabled) {
            changePreview(false);
            destroyCamera();
        }
