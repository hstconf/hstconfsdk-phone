...
import com.infowarelab.conference.ui.activity.inchat.ImageActivity;
import com.infowarelab.conference.ui.activity.inchat.view.share.DocView4Phone;
...
public class ConfDsView extends BaseFragment implements OnClickListener, OnTouchListener {
    ...
    public void doShowView(boolean hasCorrect, boolean isScrollIn) {
        ...
        Log.d("InforwareLab.Debug", "doShowView: hasCorrect:" + hasCorrect + "; isScrollIn" + isScrollIn );
        ...
        if (isScrollIn) {
            ...
            Log.d("InforwareLab.Debug", "docCommon.getDocMapList():" + docMap.size() );

            if (docMap != null && !docMap.isEmpty()) {
                curDoc = docCommon.getCurrentDoc();
                if (curDoc == null || (curDoc != null && docMap.get(0).getDocID() != curDoc.getDocID())) {
    ...
    private void doShowDoc() {
        ...
        Log.d("InfowareLab.Debug", "ConfDsView.doShowDoc()");
        ...
        if (curDoc != null) {
            ...
            Log.d("InfowareLab.Debug", "@doShowDoc(): shareView.setVisibility(View.VISIBLE)");
    ...
    private void setCurHSV(int docid) {
        ...
        Log.d("InfowareLab.Debug", "@setCurHSV: docCommon.getDocMapList():" + docMap.size() );
        ...
        if (activeDocid.curId == 0) {
            ...
            llCurDoc.setVisibility(View.VISIBLE);
            Log.d("InfowareLab.Debug", "pvDocs.setScreenWidth(1): w1=" + getParentW(getOrientationState()));
            pvDocs.setScreenWidth(getParentW(getOrientationState()), 1);
        } else if (activeDocid.lastId == 0) {
            llLastDoc.setVisibility(View.GONE);
            llNextDoc.setVisibility(View.VISIBLE);
            llCurDoc.setVisibility(View.VISIBLE);
            Log.d("InfowareLab.Debug", "pvDocs.setScreenWidth(2): w2=" + getParentW(getOrientationState()));
            ...
            llNextDoc.setVisibility(View.GONE);
            llCurDoc.setVisibility(View.VISIBLE);
            Log.d("InfowareLab.Debug", "pvDocs.setScreenWidth(2): w3=" + getParentW(getOrientationState()));
            pvDocs.setScreenWidth(getParentW(getOrientationState()), 2);
            pvDocs.setCurPage(2);
            pvDocs.requestLayout();
            //pvDocs.requestChildFocus(flCurDoc,flCurDoc);
            ...
            llCurDoc.setVisibility(View.VISIBLE);
            llNextDoc.setVisibility(View.VISIBLE);
            Log.d("InfowareLab.Debug", "pvDocs.setScreenWidth(3): w=" + getParentW(getOrientationState()));
...
//                    openDoc(curDoc);
                    Log.i("InfowareLab.Debug", "DocCommon.Doc_OPEN ");
                    break;
                case DocCommon.DOC_SHOW:
                    showDoc(msg, null);
                    Log.i("InfowareLab.Debug", "DocCommon.DOC_SHOW ");
                    break;
                ...
                case DocCommon.NEW_PAGE:
                    setPagecount(msg);
                    Log.i("InfowareLab.Debug", "DocCommon.NEW_PAGE " + msg.arg1 + "/" + msg.arg2);
                    break;
    ...
    public void showDoc(Message msg, DocBean docbean) {
        ...
        llCurDoc.setVisibility(View.GONE);
        Log.d("InfowareLab.Debug", "@showDoc: shareView.setVisibility(View.VISIBLE)");
        shareView.setVisibility(View.VISIBLE);
        //增加页码相关代码
...
//        beginCloudRecord();
    ...
    private int getParentH(int orientation) {
        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            return ConferenceApplication.Screen_W - ConferenceApplication.StateBar_H - ConferenceApplication.NavigationBar_H;
        }
    }
