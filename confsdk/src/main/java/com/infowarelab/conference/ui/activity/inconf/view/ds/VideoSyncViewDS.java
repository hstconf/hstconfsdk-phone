...
//	     addView(relative);
    ...
    public void resetSize(int width, int height, int left, int right, int top, int bottom) {
        Log.d("InfowareLab.Debug", "videosync:width=" + width + " height=" + height + " left=" + left + " right=" + right + " top=" + top + " bottom=" + bottom);
...
//		screenH=this.getHeight();
    ...
    protected int screenW = ConferenceActivity.pWidth;
    protected int screenH = ConferenceActivity.pHeight;
