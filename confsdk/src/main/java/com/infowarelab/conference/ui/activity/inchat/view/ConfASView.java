...
import com.infowarelab.conference.ui.activity.inchat.view.ds.VideoSyncViewDS;
...
public class ConfASView extends BaseFragment implements OnClickListener {
    ...
    public ConfASView(ICallParentView iCallParentView) {
...
//					if ((Boolean) msg.obj) {
//						btnSwitch.setText("鍏抽棴");
//					}else {
//						btnSwitch.setText("鎵撳紑");
//					}
//					btnSwitch.setClickable(true);
                    ...
                    case ShareDtCommon.AUDIO:
                        ...
                        //Log.e("ttttt","data鏁版嵁閲?:"+data.length);
                        break;
                    default:
                        break;
                }
...
//		if(flAs.getHeight()>1&&flAs.getHeight()<parentH)parentH = flAs.getHeight();
    ...
    private void setPML() {
        int parentH = ConferenceApplication.Screen_W - ConferenceApplication.StateBar_H - ConferenceApplication.NavigationBar_H;
        int parentW = ConferenceApplication.Screen_H;
        if (parentH * 1.0 / asCommon.getDT_HEIGHT() > parentW * 1.0 / asCommon.getDT_WIDTH()) {
            showView.initSize(parentW, (int) ((parentW * 1.0 / asCommon.getDT_WIDTH()) * asCommon.getDT_HEIGHT()), parentW, parentH);
        } else {
            showView.initSize((int) ((parentH * 1.0 / asCommon.getDT_HEIGHT()) * asCommon.getDT_WIDTH()), parentH, parentW, parentH);
